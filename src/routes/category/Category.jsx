...
import { deleteCategoryApi, getCategoryApi } from '../../components/apis/CategoryApi';
...
const Category = () => {
    ...
    const canCreateUser = permissions['/category']?.includes('create');
    const canUpdateUser = permissions['/category']?.includes('update');
    const canDeleteUser = permissions['/category']?.includes('delete');
        ...
        <Layout>
            ...
            >
                <div className="flex justify-between pb-5">
                    <h2 className={Styles.headTitle}>Category</h2>
                ...
                />
                <CenterSlideModal isOpen={isModalOpen} onClose={closeModal} title={activeForm === "formUpdate" ? "Update Category" : "Add New Category"}>
