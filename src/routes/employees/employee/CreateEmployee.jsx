...
import { message, Form, Input, Upload, Image, DatePicker, InputNumber, Select } from 'antd';
        ...
        <Form form={form} onFinish={onFinish} layout="vertical">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <Form.Item
                            ...
                            rules={[{ required: true, message: translate('language') + translate('required') }]}
                        >
                            <Select
                                mode="multiple"
                                showSearch
                                ...
                                placeholder={translate('select') + translate('language')}
                        ...
                        <Form.Item
                            ...
                            rules={[{ required: true, message: translate('designation') + translate('required') }]}
                        >
                            <Select placeholder={translate('select') + translate('designation')}>
                        ...
                        <Form.Item
                            ...
                            rules={[{ required: true, message: translate('department') + translate('required') }]}
                        >
                            <Select placeholder={translate('select') + translate('department')}>
                                {department.map((role) => (
                                    <Select.Option key={role._id} value={role._id}>
                                        {role.name}
                                    </Select.Option>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Form.Item
                    ...
                    rules={[{ required: true, message: translate('city') + translate('required') }]}
                >
                    <Input placeholder={translate('enter') + translate('city')} />
                </Form.Item>

                <Form.Item
                    name="phone"
                    label={translate('mobile')}
                    rules={[{ required: true, message: translate('mobile') + translate('required') }]}
                >
                    <Input placeholder={translate('enter') + translate('mobile')} />
                </Form.Item>

                <Form.Item
                    name="gender"
                    label={translate('gender')}
                    rules={[{ required: true, message: translate('gender') + translate('required') }]}
                >
                    <Select placeholder={translate('select') + translate('gender')}>
                        {Gender.map(gender => (
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: translate('dateOfBirth') + translate('required') }]}
                >
                    <DatePicker
                        className="w-full"
                        placeholder={translate('select') + translate('dateOfBirth')}
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: translate('email') + translate('required') }]}
                >
                    <Input placeholder="example@gmail.com" />
                </Form.Item>
                <Form.Item name="password" rules={[{ required: true, message: translate('pass') + translate('required') }]} label={translate('newPass')}>
                    <Input.Password placeholder={translate('enter') + translate('pass')} />
                </Form.Item>
