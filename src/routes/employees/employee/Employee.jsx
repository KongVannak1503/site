...
import { Breadcrumb, Layout, Table, Space, Input, Button, Avatar, Tooltip, Checkbox, Spin, Select, message } from "antd";
                ...
                <div className="flex flex-col md:flex-row justify-between pb-5">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            >
                                {NEW_USER} {translate('enterAdd')} <span className='hidden md:inline'>{translate('employee')}{translate('endNew')}</span>
                            </button>
                        </div>
                    </div>
                </div>
