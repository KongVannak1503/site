...
import { getEmployeeByIdApi, updateEmployeeApi } from '../../components/apis/EmployeeApi';
import { businessAddresses, employeeTypes, Gender, maritalStatuses, Salutation } from '../../components/utils/Constants';
...
const UpdateProject = ({ userId, onUserUpdated, onClose }) => {
